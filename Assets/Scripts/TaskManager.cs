...
public class TaskCoroutine
{
	...
	/// upon construction.
	public TaskCoroutine(IEnumerator c, bool autoStart = true)
	{
		task = TaskManagerCoroutine.CreateTask(c);
	...
	TaskManagerCoroutine.TaskState task;
}

class TaskManagerCoroutine : MonoBehaviour
{
	...
	static TaskManagerCoroutine singleton;
	...
	public static TaskState CreateTask(IEnumerator coroutine)
	{
		if (singleton == null)
		{
			...
			singleton = go.AddComponent<TaskManagerCoroutine>();
		}
